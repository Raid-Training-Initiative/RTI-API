...
import {
    ...
    GetTrainingRequest,
} from "./requests/TrainingRequests";
...
export class App {
    ...
    public async run() {
        ...
        Logger.log(
            Severity.Info,
            `Initialising API with DB ${this._config.db}`,
        );
        ...
        server.get(
            ...
            async (req: Request, res: Response, next: NextFunction) => {
                Logger.log(
                    Severity.Info,
                    `GET /raids/:id/log request initiated`,
                );
                const getRaidLog = new GetRaidLog(req, res, next);
                await getRaidLog.run();
                Logger.log(
                    Severity.Info,
                    `GET /raids/:id/log request completed`,
                );
            },
        );
        ...
        server.get(
            ...
            async (req: Request, res: Response, next: NextFunction) => {
                Logger.log(
                    Severity.Info,
                    `GET /members/:userid request initiated`,
                );
                const getMember = new GetMember(req, res, next);
                await getMember.run();
                Logger.log(
                    Severity.Info,
                    `GET /members/:userid request completed`,
                );
            },
        );
        ...
        server.delete(
            ...
            async (req: Request, res: Response, next: NextFunction) => {
                Logger.log(
                    Severity.Info,
                    `DELETE /comps/:comp request initiated`,
                );
                const deleteComp = new DeleteComp(req, res, next);
                await deleteComp.run();
                Logger.log(
                    Severity.Info,
                    `DELETE /comps/:comp request completed`,
                );
            },
        );
        ...
        server.get(
            ...
            async (req: Request, res: Response, next: NextFunction) => {
                Logger.log(
                    Severity.Info,
                    `GET /categories/:category request initiated`,
                );
                const getCategory = new GetCategory(req, res, next);
                await getCategory.run();
                Logger.log(
                    Severity.Info,
                    `GET /categories/:category request completed`,
                );
            },
        );
        ...
        server.get(
            ...
            async (req: Request, res: Response, next: NextFunction) => {
                Logger.log(
                    Severity.Info,
                    `GET /trainingrequests request initiated`,
                );
                const listTrainingRequests = new ListTrainingRequests(
                    req,
                    res,
                    next,
                );
                ...
                Logger.log(
                    Severity.Info,
                    `GET /trainingrequests request completed`,
                );
            },
        );
        ...
        server.get(
            ...
            async (req: Request, res: Response, next: NextFunction) => {
                Logger.log(
                    Severity.Info,
                    `GET /trainingrequests/:userid request initiated`,
                );
                const getTrainingRequest = new GetTrainingRequest(
                    req,
                    res,
                    next,
                );
                ...
                Logger.log(
                    Severity.Info,
                    `GET /trainingrequests/:userid request completed`,
                );
            },
        );
        ...
        server.all(
            ...
            async (req: Request, res: Response, next: NextFunction) => {
                Logger.log(
                    Severity.Info,
                    `Request made to nonexistent resource`,
                );
...
process.on("uncaughtException", (error) =>
    Logger.logError(Severity.Error, error),
);
